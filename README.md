...
| 8 | Multi-Agent Writer | planner、writer、reviewer 协作 |
| 9 | Personal Agent | OpenClaw/Hermes-style 记忆、skills、消息入口 |
| 10 | Production Harness | evals、trace、权限、CI、runner、回放 |
...
| --- | --- | --- |
| Build From Scratch | [learn-claude-code](https://github.com/shareAI-lab/learn-claude-code), [claw0](https://github.com/shareAI-lab/claw0), [HelloAgents](https://github.com/jjyaoao/HelloAgents) | agent loop、tool registry、session、context compaction、gateway、trace、subagents。 |
